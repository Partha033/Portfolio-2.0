...
using use = useUsing("use")`,
  ...
  [SkillNames.JAVA]: {
    ...
    name: "java",
    label: "Java",
    shortDescription: "The OG of programming languages",
    color: "#f0db4f",
  ...
  [SkillNames.REDUX]: {
    ...
    name: "redux",
    label: "Redux",
    shortDescription: "State management for React",
    color: "#764abc",
  ...
  [SkillNames.GRAPHQL]: {
    ...
    name: "graphql",
    label: "GraphQL",
    shortDescription: "A query language for your API",
    color: "#e10098",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Wonder Worth Solutions, Vellore",
    description: [
      "Implemented API handling using GraphQL, ensuring smooth communication between frontend and backend.",
      "Built responsive, modern UI components using React.js, Redux, JavaScript,Hooks and Tailwind CSS.",
      "Wrote unit tests to ensure code quality, stability, and maintainability.",
      "Collaborated on API testing and debugging to improve performance and reliability.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.REDUX,
  ...
  },
  {
    ...
    company: "Dotworld Technologies,Coimbatore",
    description: [
      "A Web Development and Software Engineering internship offers hands-on experience in designing, coding, and maintaining websites or software applications.",
      "Interns typically work with programming languages like HTML, CSS, JavaScript,. They also collaborate with teams to solve technical challenges",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
